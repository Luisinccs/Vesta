...
public partial class MainAuditorViewModel : ObservableObject {
    ...
    public MainAuditorViewModel(IAISocket aiSocket, IOCRSocket ocrSocket, ILegalSocket legalSocket) {
        _aiSocket = aiSocket;
    ...
    public async Task AnalyzeDocumentAsync() {
        ...
        try {
            ...
            if (_aiSocket is Infrastructure.AI.GemmaInferenceService { UseMockMode: true }) {
                ...
                documentStream = await result.OpenReadAsync();
            }
